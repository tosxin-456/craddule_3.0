    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden w-full md:h-[250px] flex flex-col">
        ...
        {isApprovedWithPayment && !application.isPaid && (
          <div className="mx-5 mb-4 rounded-2xl bg-gradient-to-br from-emerald-50 to-green-100 border border-emerald-200 p-4">
            ...
            <p className="text-xs text-emerald-800 leading-relaxed mb-3">
              Your TIN registration is approved. Complete payment below to
              finalise.
            </p>
      ...
      <div className="flex gap-2.5 px-5 pb-5">
        {isApprovedWithPayment ? (
          <>
            ...
            {application.isPaid ? (
              ...
              <button
                onClick={handlePay}
                disabled={loading}
                className="flex-1 px-4 py-2.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed"
              >
          ...
          <button
            onClick={onViewFull}
            className="flex-1 px-4 py-2.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg transition-all flex items-center justify-center gap-1.5"
          >
